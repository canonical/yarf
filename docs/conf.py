...
# Product name
project = "Yet Another Robot Framework"
...
html_context = {
    ...
    "github_url": "https://github.com/canonical/yarf",
...
#
html_theme_options = {
'source_edit_link': 'https://github.com/canonical/yarf',
}
...
# Support implicit heading as targets. This is should be set to an integer,
# between 1 and 6, indicating the depth of headings to assign targets to.
