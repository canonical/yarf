"""
This module provides the Zapper-driven implementation for
video interactions and assertions.
"""
...
class HdmiIn(VideoSource):
    ...
    def __init__(self):
        ...
        there are common situation where the DUT is not displaying anything
        via HDMI. This makes the B101/v4l block: handling v4l2 at low
        level is just not possible with OpenCV. uStreamer on the other
        hand already has a nice implementation of recovering/reloading
        the device when this happens.
        """
    ...
    def grab_screenshot(self) -> Image.Image:
        ...
        To make it _really_ faster we're pointing to
        a snapshot HTML page, not the real streaming.
        Hence, we have to create a new VideoCapture each time.
        """
